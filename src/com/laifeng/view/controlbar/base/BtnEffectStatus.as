package com.laifeng.view.controlbar.base
{
	...
	public class BtnEffectStatus extends Sprite
	{
		
		public const E_EFFECT_STATUS_CHANGE:String ="E_EFFECT_STATUS_CHANGE";
		
		public const STATUS_OFF:String = "STATUS_OFF";
		public const STATUS_ON:String  = "STATUS_ON";
		
		
		public function BtnEffectStatus()
		{
			super();
			
			_btnOff = new ButtonShape(new Skin2_btn_effect_off());
			_btnOn = new ButtonShape(new Skin2_btn_effect_on());
		...
		private function statusChangeHandler(event:MouseEvent):void{
			this.dispatchEvent(new Event(E_EFFECT_STATUS_CHANGE));
		}
